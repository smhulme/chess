...
public class GameService {
    ...
    public boolean joinGame(String authToken, int gameID, String color) throws UnauthorizedException, BadRequestException {
        ...
        if (Objects.equals(color, "WHITE")) {
            ...
            else whiteUser = registerResponse.username();
        } else if (Objects.equals(color, "BLACK")) {
            if (blackUser != null) return false; // Spot taken
            else blackUser = registerResponse.username();
        ...
        } else if (!color.equals("WHITE") && !color.equals("BLACK")) { // Check for other invalid colors like "GREEN"
